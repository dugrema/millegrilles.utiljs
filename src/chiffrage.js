...
let chiffrageAsymmetrique = {}
export function setChiffrageAsymmetrique(algorithmes, opts) {
  opts = opts || {}
  if(opts.update === true) {
    chiffrageAsymmetrique = {...chiffrageAsymmetrique, ...algorithmes}
  } else {
    chiffrageAsymmetrique = algorithmes
  }
}
